...
const FormChoiceButton = styled.div`
    ...
    box-shadow: ${props => props.pressed ? '0.06vw 0.08vw 0 #333333' : '0.1vw 0.2vw 0.1vw #333333'};
        ...
        return (
            <div style={pageStyle}>
                ...
                <div style={formContainerStyle}>
                    <FormChoiceButton pressed={this.state.menu === "Sign Up"} onClick={this.setMenu("Sign Up")}>
                        <p>Want to Join?</p>
                        <h3>Sign up!</h3>
                    </FormChoiceButton>
                    <FormChoiceButton pressed={this.state.menu === "Log In"} onClick={this.setMenu("Log In")}>
                        <p>Have an Account?</p>
                        <h3>Log in!</h3>
                    </FormChoiceButton>
                </div>
